...
export class PowerBIEmbed extends React.Component<EmbedProps> {
	...
	private containerRef = React.createElement<HTMLElement>('div');
	...
	componentDidMount(): void {
		...
		if (this.containerRef) {
			...
			if (this.props.embedConfig.accessToken && this.props.embedConfig.embedUrl) {
				...
				this.embed = this.powerbi.bootstrap(this.containerRef, this.props.embedConfig);
			}
		}
	...
	componentWillUnmount(): void {
		// Clean Up
			this.powerbi.reset(this.containerRef);
	};
    ...
    <body>
        <div ref={this.containerRef} id="reportContainer"></div>
        <script>
    </body>
    </html>`
		return (
